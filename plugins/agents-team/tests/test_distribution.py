...
class DistributionTests(unittest.TestCase):
    def test_build_distribution_contains_installable_marketplace(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("plugins/agents-team/skills/submit-team-feedback/SKILL.md", names)
            self.assertIn("plugins/agents-team/skills/submit-team-feedback/agents/openai.yaml", names)
            self.assertIn("plugins/agents-team/scripts/submit_feedback.py", names)
